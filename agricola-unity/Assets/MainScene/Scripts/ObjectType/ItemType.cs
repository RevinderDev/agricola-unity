...
public class ItemType : Type
{
    ...
    //seeds
    public static readonly ItemType carrotSeeds = new ItemType("carrot seeds", "Sprites/seeds_carrot", 0, 1, true, true, 0, 1);
    public static readonly ItemType tomatoSeeds = new ItemType("tomato seeds", "Sprites/seeds_tomato", 0, 1, true, true, 0, 1);
    public static readonly ItemType pumpkinSeeds = new ItemType("pumpkin seeds", "Sprites/seeds_pumpkin", 0, 1, true, true, 0, 1);
    //plants
    public static readonly ItemType carrot = new ItemType("carrot", "Sprites/carrot", 2, 5, true, false, 1, 2);
    public static readonly ItemType tomato = new ItemType("tomato", "Sprites/tomato", 3, 7, true, false, 2, 4);
